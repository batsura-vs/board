...
!function (A, e) {
    ...
    ***************************************************************************** */
    ...
    function w(A, e, t, r, n) {
        ...
        if (-1 !== [D, y, v, p, N].indexOf(c)) for (var Q = B; 0 <= Q;) {
            if ((w = e[Q]) === D) return Y;
    ...
    var i, U, E, F, h, H = 10, d = 13, f = 15, p = 17, N = 18, m = 19, R = 20, L = 21, O = 22, v = 24, D = 25, b = 26,
    ...
    var CA = {type: sA.LEFT_PARENTHESIS_TOKEN}, gA = {type: sA.RIGHT_PARENTHESIS_TOKEN}, EA = {type: sA.COMMA_TOKEN},
        ...
        LA = {type: sA.COLON_TOKEN}, OA = {type: sA.SEMICOLON_TOKEN}, vA = {type: sA.LEFT_SQUARE_BRACKET_TOKEN},
    ...
    var ye = (_e.prototype.addImage = function (A) {
        ...
        return new Promise(function (e, t) {
            var r = ve.SUPPORT_RESPONSE_TYPE ? "blob" : "text", n = new XMLHttpRequest;
    ...
    var Dt, bt, St = Ot("top"), Mt = Ot("right"), yt = Ot("bottom"), _t = Ot("left"), Pt = vt("top"), xt = vt("right"),
        Vt = vt("bottom"), zt = vt("left"),
    ...
    }, qr = {name: "font-size", initialValue: "0", prefix: !1, type: Ce.TYPE_VALUE, format: "length"}, Zr = {
    ...
    var cn, Qn = function (A) {
        ...
        this.text = Hn(A.data, e.textTransform), this.textBounds = function (A, t, r) {
            ...
            return e.forEach(function (A) {
                if (t.textDecorationLine.length || 0 < A.trim().length) if (ve.SUPPORT_RANGE_BOUNDS) n.push(new ln(A, gn(r, B, A.length))); else {
    ...
    function Ln(A) {
        var e = mn.call(this, A) || this, t = new XMLSerializer;
    ...
    var yn, _n = [{type: sA.DIMENSION_TOKEN, flags: 0, unit: "px", number: 3}],
        Pn = [{type: sA.PERCENTAGE_TOKEN, flags: 0, number: 50}], xn = "checkbox", Vn = "radio", zn = "password",
        Xn = 707406591, Jn = (A(Gn, yn = Un), Gn);
    ...
    function Yn(A) {
        var e = kn.call(this, A) || this, t = A.options[A.selectedIndex || 0];
    ...
    var nB = ["OL", "UL", "MENU"], BB = function (A, e, t) {
        for (var r = A.firstChild, n = void 0; r; r = n) if (n = r.nextSibling, cB(r) && 0 < r.data.trim().length) e.textNodes.push(new hn(r, e.styles)); else if (QB(r)) {
            var B = sB(r);
    ...
    var LB, OB, vB = {
        ...
        if (e) {
            ...
            if (C && r && "none" !== r && "-moz-alt-content" !== r && "none" !== e.display) {
                ...
                var g = new Qn(e), E = C.createElement("html2canvaspseudoelement");
    ...
    function ds(A, e, t) {
        var r = function (A, e) {
            ...
            }(ms(A.styles.backgroundOrigin, e), A), n = function (A, e) {
                return A === Ee.BORDER_BOX ? e.bounds : A === Ee.CONTENT_BOX ? Hs(e) : hs(e)
            }(ms(A.styles.backgroundClip, e), A), B = Ts(ms(A.styles.backgroundSize, e), t, r), s = B[0], o = B[1],
    ...
    var Ns = function (c, Q, w, u) {
        c.container.elements.forEach(function (A) {
            var e = $r(A.flags, 4), t = $r(A.flags, 2), r = new Es(A, c.getParentEffects());
            $r(A.styles.display, 2048) && u.push(r);
            var n = $r(A.flags, 8) ? [] : u;
            if (e || t) {
                var B = e || A.styles.isPositioned() ? w : Q, s = new gs(r);
    ...
    }, Ls = "Hidden Text", Os = (vs.prototype.parseMetrics = function (A, e) {
